! function(t) {
    ...
    "5+9/": function(t, e, r) {
        var n = r("ZOjo"),
            ...
            s = r("QamB"),
            a = r("9rXv"),
            c = r("Fy0/")("engine.io-client:polling");
        t.exports = h;
    ...
    "63KW": function(t, e, r) {
        ...
        (function(t) {
            ...
            c.prototype.slice = function(t, e) {
                ...
                return t = +t, e |= 0, r || U(this, t, e, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : D(this, t, e, !0), e + 4
            }, c.prototype.writeUInt32BE = function(t, e, r) {
                return t = +t, e |= 0, r || U(this, t, e, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : D(this, t, e, !1), e + 4
                ...
                return t = +t, e |= 0, r || U(this, t, e, 4, 2147483647, -2147483648), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : D(this, t, e, !0), e + 4
            }, c.prototype.writeInt32BE = function(t, e, r) {
                return t = +t, e |= 0, r || U(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : D(this, t, e, !1), e + 4
    ...
    AYMf: function(t, e, r) {
        var n = r("Xz3Q"),
            ...
            s = r("SJFm"),
            a = r("zqJT"),
            c = r("Fy0/")("socket.io-client:socket"),
            u = r("gVZZ"),
            h = r("5+KW");
        t.exports = l;
        var f = {
    ...
    Ctjl: function(t, e, r) {
        var n = r("psuf"),
            ...
            a = r("SJFm"),
            c = r("zqJT"),
            u = r("Fy0/")("socket.io-client:manager"),
            h = r("Csua"),
            f = r("+lzb"),
    ...
    "Fy0/": function(t, e, r) {
        (function(n) {
            ...
            }(e = t.exports = r("vmzn")).log = function() {
    ...
    Xqxu: function(t, e, r) {
        (function(e) {
            var n = r("Y+et"),
                o = r("pnVU"),
                i = r("Fy0/")("engine.io-client:socket"),
                s = r("Csua"),
                a = r("ElvI"),
                c = r("fOB9"),
                u = r("gVZZ");
    ...
    cwTZ: function(t, e, r) {
        (function(e) {
            var n, o = r("ZOjo"),
                ...
                a = r("QamB"),
                c = r("9rXv"),
                u = r("Fy0/")("engine.io-client:websocket"),
    ...
    nXuP: function(t, e, r) {
        (function(e) {
            var n = r("P2cu"),
                ...
                i = r("pnVU"),
                s = r("QamB"),
                a = r("Fy0/")("engine.io-client:polling-xhr");
    ...
    "p/XV": function(t, e) {
        var r = ".js-burger, .js-nav";
        $(".js-burger").on("click", function(t) {
            t.preventDefault(t), $(".js-burger").hasClass("js-active") ? $(r).removeClass("js-active") : $(r).addClass("js-active")
        }), $(document).mouseup(function(t) {
            var e = $(".js-nav");
            e.is(t.target) || 0 !== e.has(t.target).length || $(".js-burger").is(t.target) || $(r).removeClass("js-active"), $(t.target).closest(".students__student-text").hasClass("students__student-text") && ($(t.target).closest(".students__student-text").toggleClass("students__active-student"), $(t.target).closest(".students__student-text").siblings(".students__gradient-block").toggle())
        })
    },
    pDpM: function(t, e) {
        var r = {}.toString;
    ...
    wxxG: function(t, e, r) {
        ...
        "undefined" !== (void 0 === s ? "undefined" : n(s)) && !1 !== s && (h.page = s), u.on("id", function(t) {
